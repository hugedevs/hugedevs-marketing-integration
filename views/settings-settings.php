        ...
        <table class="form-table">
            <tbody>
                <tr>
                    ...
                    <td>
                        <input name="HugedevsMarketingIntegration_rdstation_api_key" type="text" id="HugedevsMarketingIntegration_rdstation_api_key"
                            value="<?php echo get_option("HugedevsMarketingIntegration_rdstation_api_key"); ?>" class="regular-text" />
                    </td>
                </tr>
            </tbody>
        </table>
